...
namespace POO_FilmesSeries
{
	class Program
	{
		static SerieRepositorio repositorio1 = new SerieRepositorio();
		...
		private static void ExcluirSerie()
		{
			...
			repositorio1.Exclui(indiceSerie);
		}
		...
		private static void InserirSerie()
		{
			...
			Serie novaSerie = new Serie(id: repositorio1.ProximoId(),
										genero: (Genero)entradaGenero,
										titulo: entradaTitulo,
										ano: entradaAno,
										descricao: entradaDescricao);
		...
		{
			Console.WriteLine();
			Console.WriteLine("POO Filmes e Séries");
